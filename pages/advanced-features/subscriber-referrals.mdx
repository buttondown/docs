...
export const meta = {
  title: "Subscriber referrals",
  description:
    "An explanation of how subscriber-to-subscriber referrals work in Buttondown.",
};
...
<Notice variant="info">
    This functionality and documentation is a work in progress! You can follow along with the rest of the work <a className="text-green-700 underline" href="https://github.com/buttondown-email/roadmap/issues/471">here</a>.
</Notice>
...
```
https://buttondown.email/<yourusername>/referral/{{ subscriber.referral_code }}
```
...
from [this link](https://buttondown.email/<yourusername>/referral/{{ subscriber.referral_code }}), 
...
2. You can view an aggregate list of all referrals made by all subscribers to your newsletter by heading over to your [Analytics page](https://buttondown.email/analytics). The topline modal has a total aggregation of referrals for 
the given date range you've selected, grouped by subscriber.
3. You can export all of your data, which contains an itemized list of all subscriber referrals made by all subscribers to your newsletter.
...
Please let me know on the [tracking ticket](https://github.com/buttondown-email/roadmap/issues/471) for the feature! I'm all ears.