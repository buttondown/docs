...
With the caveat that [not every email client supports custom web fonts](https://www.litmus.com/blog/the-ultimate-guide-to-web-fonts/), it's actually fairly easy to specify a custom web font! You'll just want to supply some custom CSS in your [Design settings page](https://buttondown.email/settings) like the following:
