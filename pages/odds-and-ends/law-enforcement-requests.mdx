...
Buttondown will automatically and without exception disclose to users when an organization has requested information that pertains to them, unless Buttondown is expolicitly prohibited from doing so by law.
