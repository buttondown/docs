...
8. Add the CNAME records - Follow the steps below for each record that has “CNAME” in the “TYPE” column:
...
9. If it were a pie, you’d wait for it to bake. But it’s computers, so Namecheap can take up to 24 hours to process your update. This is a good opportunity to go bake a pie.
...
<b>See Also:</b> <a
    className="text-green-800 underline"
    href="/getting-started/hosting-domains/hosting-on-namecheap"
  >Hosting on Namecheap</a> if you want to host your archives on a custom domain (like <tt>newsletter.buttondown.xyz</tt>) instead of the default (<tt>buttondown.email/buttondownxyznews</tt>). Available with a <a
    className="text-green-800 underline"
