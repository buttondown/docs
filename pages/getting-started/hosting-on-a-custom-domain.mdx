...
**Hosting on a custom domain** means using a domain outside of `buttondown.email` to host your newsletter and archives — for example, [newsletter.arcana.computer](https://newsletter.arcana.computer) or [weeknotes.buttondown.email](http://weeknotes.buttondown.email).
