...
Already have a list of subscribers? Have no fear! You can upload that list to Buttondown as a [CSV](/odds-and-ends/glossary#csv) (or "comma-separated values") file. Buttondown can automatically import the following values for each of your subscribers:
...
- Tags (read more about tags [here](/getting-started/building-your-subscriber-base#adding-tags-to-your-subscribers))

- Metadata (read more about metadata [here](/getting-started/building-your-subscriber-base#adding-metadata-to-your-subscribers))
