...
<Endpoint method="PATCH" path="/v1/subscribers/<id>" />
...
<Endpoint method="DELETE" path="/v1/subscribers/<id>" />
...
<Endpoint method="GET" path="/v1/subscribers/<id>" />
...
<ClosedBetaNotice />
<Endpoint method="POST" path="/v1/subscribers/<id>/emails/<email_id>" />
